        ...
        switch (state) {
            ...
            case ThresholdState::STARTED: {
                ...
                if (count >= nThreshold) {
                    ...
                    stateNext = (fHeightBased && LockInOnTimeout(params)) ? ThresholdState::LOCKED_IN : ThresholdState::FAILED;
                }
                break;
            }
...
protected:
    ...
    bool LockInOnTimeout(const Consensus::Params& params) const override { return params.vDeployments[id].lockin_on_timeout; }
