...
void SetupServerArgs(NodeContext& node)
{
    ...
    argsman.AddArg("-validityallowmigrationprofiles", "Allow sendvaliditysidechainregister to create new sidechains using migration-only validity proof profiles. Without this opt-in, new registrations must use the canonical groth16_bls12_381_poseidon_v2 profile.", ArgsManager::ALLOW_BOOL | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
#else
