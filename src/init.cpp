...
void SetupServerArgs(NodeContext& node)
{
    ...
    argsman.AddArg("-validityallowmigrationprofiles", "Allow sendvaliditysidechainregister to create new sidechains using migration-only validity proof profiles. Without this opt-in, new registrations must use the canonical groth16_bls12_381_poseidon_v3 profile; legacy groth16_bls12_381_poseidon_v2 registrations now also require this flag.", ArgsManager::ALLOW_BOOL | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
#else
    ...
    hidden_args.emplace_back("-validityallowmigrationprofiles");
#endif
#ifndef WIN32
