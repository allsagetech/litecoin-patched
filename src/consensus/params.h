...
struct BIP9Deployment {
    ...
    /**
     * For height-based BIP8 deployments only:
     *  - true: timeout transitions STARTED -> LOCKED_IN (mandatory activation)
     *  - false: timeout transitions STARTED -> FAILED
     */
    bool lockin_on_timeout = true;
