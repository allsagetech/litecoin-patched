...
public:
    ...
    /**
     * Index validity-sidechain withdrawal executions by (sidechain_id, withdrawal_id).
     */
     ...
     * check does nothing.
     */
    void check(const CCoinsViewCache *pcoins, const Consensus::Params& consensus_params) const;
