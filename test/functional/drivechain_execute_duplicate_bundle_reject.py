...
class DrivechainExecuteDuplicateBundleReject(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        n.senddrivechainexecute(scid, bundle_hash, withdrawals)
        assert_raises_rpc_error(
            -26,
            "dc-exec-duplicate-bundle-mempool",
...
if __name__ == "__main__":
    DrivechainExecuteDuplicateBundleReject().main()
