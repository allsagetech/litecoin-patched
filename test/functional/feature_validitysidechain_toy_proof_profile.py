...
class ValiditySidechainToyProofProfileTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(real_supported["batch_proof_queue_witness_limit"], 1)
        assert_equal(real_supported["batch_proof_withdrawal_witness_limit"], 1)
        ...
        assert_equal(real_v2_supported["batch_queue_binding_mode"], "proof_bound_prefix_commitment_bounded_experimental")
        assert_equal(real_v2_supported["batch_withdrawal_binding_mode"], "accepted_root_bounded_witness_experimental")
        assert_equal(real_v2_supported["batch_proof_queue_witness_limit"], 2)
        assert_equal(real_v2_supported["batch_proof_withdrawal_witness_limit"], 2)
