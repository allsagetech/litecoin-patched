...
BASE_SCRIPTS = [
    ...
    'p2p_leak.py',
    'feature_drivechain_activation.py',
    'feature_drivechain_state.py',
    'feature_drivechain_miner_votes.py',
    ...
    'validitysidechain_resource_bounds.py',
    ...
    'validitysidechain_long_range_escape_exit_reorg.py',
    ...
    'drivechain_bundle_requires_sidechain.py',
    'drivechain_bundle_pruning.py',
    'drivechain_bundlehash_mismatch_reject.py',
    'drivechain_execute_duplicate_bundle_reject.py',
    'drivechain_stale_execute_template.py',
    'drivechain_execute_escrow_credit.py',
    'drivechain_execute_requires_approval.py',
    'drivechain_reject_pre_activation.py',
    'drivechain_softfork_activation_boundary.py',
    'drivechain_softfork_reorg_deactivation.py',
    'drivechain_reorg_state_rollback.py',
    'drivechain_reorg_snapshot_fallback.py',
    'drivechain_same_block_deposit_escrow.py',
    'drivechain_vote_coinbase_only.py',
    ...
    'drivechain_register_confirmation_required.py',
    'drivechain_vote_required_in_window.py',
    'drivechain_vote_window_boundary.py',
    'drivechain_bmm_block_rules.py',
    'drivechain_bmm_request_rpc.py',
    'drivechain_bmm_stale_request_replacement.py',
...
def check_script_prefixes():
    ...
    good_prefixes_re = re.compile("(example|feature|interface|mempool|mining|p2p|rpc|wallet|tool|ltc|mweb|drivechain|validitysidechain)_")
